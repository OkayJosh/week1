...
circom Multiplier3.circom --r1cs --wasm --sym -o Multiplier3_plonk --c
snarkjs r1cs info Multiplier3_plonk/Multiplier3.r1cs



snarkjs plonk setup Multiplier3_plonk/Multiplier3.r1cs pot12_final.ptau Multiplier3_plonk/circuit_final.zkey
